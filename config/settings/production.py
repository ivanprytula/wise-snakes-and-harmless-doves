...
# DATABASES
# ------------------------------------------------------------------------------
DATABASES["default"] = config("DATABASE_URL", cast=dj_database_url.parse)  # noqa F405
...
# STATIC
# ------------------------
STATICFILES_STORAGE = "snakes_n_doves.utils.storages.StaticRootGoogleCloudStorage"
# https://github.com/antonagestam/collectfast --> last release was on Jun, 6, 2020
# COLLECTFAST_STRATEGY = "collectfast.strategies.gcloud.GoogleCloudStrategy"
STATIC_URL = f"https://storage.googleapis.com/{GS_BUCKET_NAME}/static/"
# MEDIA
# ------------------------------------------------------------------------------
DEFAULT_FILE_STORAGE = "snakes_n_doves.utils.storages.MediaRootGoogleCloudStorage"
...
DEFAULT_FROM_EMAIL = config(
    ...
    default="snakes_n_doves <noreply@example.com>",
)
